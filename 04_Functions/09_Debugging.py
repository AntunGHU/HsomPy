...
# Namjerna greska je u neispravnom identanju return-a. 
# Debug pocinje s na Debug-view generiranjem fajla "launch.json" (klik na plavo "create a launch.json" i biranjem opcije "Python File debug currently active python file ").
...
# Tip: ovdje smo BP stavili na start ali ako znamo gdje bi mogao biti problem BP mozemo odmah tamo! na L16 pa ce odmah uci u funkciju! Ako smo u funkciji i znamo da je tamo sve ok, ne moramo cekati loop nego mozemo odmah izaci sa SHIFT F11 ili strelicom Out
